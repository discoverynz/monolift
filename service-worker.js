const CACHE_NAME = 'monolift-v334';
const SHELL = ['./', './index.html', './css/styles.css?v=334', './js/app.js?v=334', './js/supabase-client.js?v=334', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigation){
    ...
    // HTML names versioned assets (app.js?v=334), so stale HTML boots stale
