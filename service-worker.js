const CACHE_NAME = 'monolift-v331';
const SHELL = ['./', './index.html', './css/styles.css?v=331', './js/app.js?v=331', './js/supabase-client.js?v=331', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigation){
    ...
    // HTML names versioned assets (app.js?v=331), so stale HTML boots stale
