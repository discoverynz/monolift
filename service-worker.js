const CACHE_NAME = 'monolift-v338';
const SHELL = ['./', './index.html', './css/styles.css?v=338', './js/app.js?v=338', './js/supabase-client.js?v=338', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigation){
    ...
    // HTML names versioned assets (app.js?v=338), so stale HTML boots stale
