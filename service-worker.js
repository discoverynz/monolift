const CACHE_NAME = 'monolift-v330';
const SHELL = ['./', './index.html', './css/styles.css?v=330', './js/app.js?v=330', './js/supabase-client.js?v=330', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigation){
    ...
    // HTML names versioned assets (app.js?v=330), so stale HTML boots stale
