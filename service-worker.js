const CACHE_NAME = 'monolift-v335';
const SHELL = ['./', './index.html', './css/styles.css?v=335', './js/app.js?v=335', './js/supabase-client.js?v=335', './manifest.json'];
...
self.addEventListener('fetch', (event) => {
  ...
  if (isNavigation){
    ...
    // HTML names versioned assets (app.js?v=335), so stale HTML boots stale
